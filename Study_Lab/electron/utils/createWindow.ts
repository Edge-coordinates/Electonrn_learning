...
function createWindow() {
  ...
  // * 主窗口加载外部链接
  // if (NODE_ENV === "development") Window.loadURL("http://localhost:5173/"); // 开发环境,加载vite启动的vue项目地址
  if (NODE_ENV === "development") Window.loadFile(path.join(__dirname, "..", "dist/index.html"));
